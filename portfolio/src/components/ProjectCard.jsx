function ProjectCard({imgLink,title,link,bannerTitle}) {
  return (
    <div className="relative bg-white w-72 h-72 group hover:shadow-xl font-sans border-1 rounded-xl border-green-700 hover:scale-105 duration-500 ">
        <span className="border border-green-700 shadow-md absolute -right-10 font-bold top-3 inline-block absolute bg-green-700 px-4 py-1 rounded-2xl text-white">{bannerTitle}</span>
